...
export default function Logo() {
    ...
    return <img src={CONFIG.strapi+settings.settings} alt="Company logo" className="logo"/>
    // <div className="logo" style={{backgroundImage:"url("+CONFIG.strapi+settings.settings+")"}}/>
}
